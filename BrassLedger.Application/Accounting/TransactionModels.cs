...
public sealed record JournalLineRequest(string AccountNumber, decimal Debit, decimal Credit, string Description, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
...
public sealed record SaveTrackingDimensionValueRequest(Guid? Id, string DimensionType, Guid? ParentTrackingDimensionValueId, string Code, string Name, string Description, DateOnly? EffectiveFrom = null, DateOnly? EffectiveThrough = null, bool IsActive = true, string ConcurrencyToken = "");
...
public sealed record SalesInvoiceLineRequest(string Description, decimal Quantity, decimal UnitPrice, decimal DiscountAmount, decimal TaxAmount, string RevenueAccountNumber, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
public sealed record CreateInvoiceRequest(Guid CustomerId, string InvoiceNumber, DateOnly InvoiceDate, DateOnly DueDate, decimal Subtotal, decimal TaxAmount, string RevenueAccountNumber, string Description, IReadOnlyList<SalesInvoiceLineRequest>? Lines = null, string Currency = "", Guid? ExchangeRateId = null);
public sealed record VendorBillLineRequest(string Description, decimal Quantity, decimal UnitCost, decimal DiscountAmount, decimal TaxAmount, string ExpenseAccountNumber, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
public sealed record CreateVendorBillRequest(Guid VendorId, string BillNumber, DateOnly BillDate, DateOnly DueDate, decimal TotalAmount, string ExpenseAccountNumber, string Description, IReadOnlyList<VendorBillLineRequest>? Lines = null, string Currency = "", Guid? ExchangeRateId = null);
public sealed record ApplyInvoicePaymentRequest(Guid InvoiceId, Guid BankAccountId, DateOnly PaymentDate, decimal Amount, string Reference, Guid? ExchangeRateId = null);
public sealed record ApplyBillPaymentRequest(Guid VendorBillId, Guid BankAccountId, DateOnly PaymentDate, decimal Amount, string Reference, Guid? ExchangeRateId = null);
public sealed record PaymentDocumentApplicationRequest(Guid DocumentId, decimal Amount);
public sealed record RecordCustomerPaymentRequest(Guid CustomerId, Guid BankAccountId, DateOnly PaymentDate, decimal Amount, string Reference, string Method, IReadOnlyList<PaymentDocumentApplicationRequest> Applications, string Currency = "", Guid? ExchangeRateId = null);
...
public sealed record RefundUnappliedPaymentRequest(Guid PaymentId, Guid BankAccountId, DateOnly RefundDate, decimal Amount, string Reference, string Reason, Guid? ExchangeRateId = null);
...
public sealed record PayrollEarningInput(string EarningCode, string EarningType, decimal Hours, decimal Rate, decimal Amount, bool IsTaxable = true, DateOnly? WorkedOn = null, string WorkState = "", string WorkCounty = "", string WorkCity = "", string WorkSchoolDistrict = "", Guid? SourceTimeEntryId = null, PayrollW2ReportingInput? W2Reporting = null, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
...
public sealed record PayrollTimeEntryInput(DateOnly WorkDate, string EarningCode, string EarningType, decimal Hours, decimal Rate, decimal Amount, bool IsTaxable = true, string WorkState = "", string WorkCounty = "", string WorkCity = "", string WorkSchoolDistrict = "", Guid? ProjectJobId = null, string Notes = "", PayrollW2ReportingInput? W2Reporting = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
...
public sealed record SaveProjectPhaseRequest(Guid? Id, Guid ProjectJobId, Guid? ParentProjectPhaseId, string Code, string Name, string Kind, string Description, DateOnly? StartsOn, DateOnly? EndsOn, bool IsActive = true, string ConcurrencyToken = "");
public sealed record SaveProjectCostCodeRequest(Guid? Id, string Code, string Name, string Category, string Description, bool IsActive = true, string ConcurrencyToken = "");
public sealed record SaveProjectBudgetAllocationRequest(Guid? Id, Guid ProjectJobId, Guid? ProjectPhaseId, Guid? ProjectCostCodeId, string AccountNumber, DateOnly PeriodStart, DateOnly PeriodEnd, decimal BudgetAmount, decimal ForecastAmount, string Notes, string ConcurrencyToken = "");
...
public sealed record SalesOrderLineRequest(Guid InventoryItemId, string Description, decimal Quantity, decimal UnitPrice, decimal DiscountAmount, decimal TaxAmount, string RevenueAccountNumber, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
...
public sealed record PurchaseOrderLineRequest(Guid InventoryItemId, string Description, decimal Quantity, decimal UnitCost, Guid? ProjectJobId = null, Guid? ProjectPhaseId = null, Guid? ProjectCostCodeId = null, Guid? DepartmentId = null, Guid? ClassId = null);
...
public sealed record PurchaseInvoiceMatchLineRequest(Guid InventoryReceiptLineId, decimal Quantity, decimal UnitCost);
public sealed record SavePurchaseInvoiceMatchRequest(Guid? Id, Guid InventoryReceiptId, string BillNumber, DateOnly BillDate, DateOnly DueDate, string Description, IReadOnlyList<PurchaseInvoiceMatchLineRequest> Lines, string ReceiptConcurrencyToken, string ConcurrencyToken = "");
public sealed record SubmitPurchaseInvoiceMatchRequest(Guid PurchaseInvoiceMatchId, string ConcurrencyToken);
public sealed record DecidePurchaseInvoiceMatchRequest(Guid PurchaseInvoiceMatchId, bool Approve, string Reason, string ConcurrencyToken);
public sealed record CancelPurchaseInvoiceMatchRequest(Guid PurchaseInvoiceMatchId, string Reason, string ConcurrencyToken);
public sealed record PostPurchaseInvoiceMatchRequest(Guid PurchaseInvoiceMatchId, string ConcurrencyToken);
public sealed record ReversePurchaseInvoiceMatchRequest(Guid PurchaseInvoiceMatchId, DateOnly ReversalDate, string Reason, string ConcurrencyToken);
...
{
    Task<TransactionResult> SaveTrackingDimensionValueAsync(SaveTrackingDimensionValueRequest request, CancellationToken cancellationToken = default);
    ...
    Task<TransactionResult> RejectSubledgerDocumentAsync(RejectSubledgerDocumentRequest request, CancellationToken cancellationToken = default);
    ...
    Task<TransactionResult> SaveProjectPhaseAsync(SaveProjectPhaseRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> SaveProjectCostCodeAsync(SaveProjectCostCodeRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> SaveProjectBudgetAllocationAsync(SaveProjectBudgetAllocationRequest request, CancellationToken cancellationToken = default);
    ...
    Task<TransactionResult> SavePurchaseInvoiceMatchAsync(SavePurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> SubmitPurchaseInvoiceMatchAsync(SubmitPurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> DecidePurchaseInvoiceMatchAsync(DecidePurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> CancelPurchaseInvoiceMatchAsync(CancelPurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> PostPurchaseInvoiceMatchAsync(PostPurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
    Task<TransactionResult> ReversePurchaseInvoiceMatchAsync(ReversePurchaseInvoiceMatchRequest request, CancellationToken cancellationToken = default);
