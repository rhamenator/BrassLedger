...
public sealed record TaxContentImportRule(string Code, string JurisdictionCode, string JurisdictionName, string JurisdictionType, string TaxType, string CalculationMethod, string WithholdingFrequency, bool IsEmployerSpecific, IReadOnlyList<TaxContentImportParameter> Parameters, IReadOnlyList<TaxContentImportTest> Tests);
