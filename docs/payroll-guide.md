...
Disaster postponements and penalty/interest computation are not implemented. Employers must confirm exceptional relief and actual payment settlement directly against their IRS account and adviser.
...
The lifecycle, protected fields, auditable timecards, detailed earning entry, multi-location earning allocation, 2026 FIT/FICA engine, effective-dated deduction/election plans, configurable federal legal limits, reconciled liability/remittance subledger, approved Form 941 monthly/semiweekly/next-day and small-liability return-payment due dates, deposit-shortfall monitoring, employee payment instructions, protected ACH/check/NACHA exports, reconciled registers/pay statements, source-locked federal filing preparation data, quarter/year close controls, ledger posting, and reversal controls are implemented and tested. BrassLedger is not yet ready for live payroll until the remaining payroll goal is completed: federal disaster-relief exceptions, transmitted federal/state/local forms and correction workflows, authoritative reciprocity and special-allocation content, all required state/local executable content and legal-limit packages, bank acceptance of payment formats, and independent accounting/tax/legal review.
