...
| Multi-currency and consolidation | Partially implemented | The foundational report derives member balances from posted ledger lines through the requested date, retains inactive historical accounts, applies the effective direct/inverse rate and controlled non-overlapping ownership period, and audits concurrency-safe ownership changes. Transaction remeasurement, rate policies, gains/losses, explicit account mapping, noncontrolling interest, intercompany matching/eliminations, retained consolidation adjustments, and complete consolidated statements remain incomplete. |
