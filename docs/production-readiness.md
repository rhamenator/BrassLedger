...
| Multi-currency and consolidation | Partially implemented | The foundational consolidated balance report derives each member balance from posted ledger lines through the requested as-of date, including inactive historical accounts, and applies the latest effective direct or inverse rate; transaction remeasurement, rate policies, gains/losses, ownership periods, explicit account mapping, intercompany matching/eliminations, and complete consolidated statements remain incomplete. |
