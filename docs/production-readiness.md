...
| Advanced project accounting | Partially implemented | Controlled change orders, source-derived billing, contract caps, retainage withholding/release, and invoice separation of duties are implemented; separate retainage receivables/aging, WIP, automated revenue recognition, phases/cost codes, and full historical export remain open. |
...
- Project dimensioning, lifecycle, derived actuals, purchase commitments, recent-ledger drill-down, controlled change orders, source-derived billing, and retainage release are implemented. Separate retainage receivables/aging, WIP, automated revenue recognition, phased budgets, and full historical ledger export are not yet complete.
