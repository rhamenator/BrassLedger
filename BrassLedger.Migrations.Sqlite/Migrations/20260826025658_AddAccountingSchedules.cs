        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidualAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    AnnualInterestRate = table.Column<decimal>(type: "TEXT", precision: 9, scale: 6, nullable: false),
                    RelatedAssetAccountId = table.Column<Guid>(type: "TEXT", nullable: true),
                    BalanceAccountId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ExpenseAccountId = table.Column<Guid>(type: "TEXT", nullable: false),
                    PaymentBankAccountId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    AccountingScheduleId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountingScheduleInstallments_AccountingSchedules_AccountingScheduleId",
