...
New York's state capture is in `us/ny/2026-source-capture.json` and links the existing NYC/Yonkers local capture. It preserves deduction and exemption tables, both annual exact schedules, the non-marginal whole-wage top-income method, supplemental rate, resident credit, source allocation, convenience and short-term policies, carrier rules, and filing schedules. Direct tables and complete short-term/convenience execution remain activation blockers.
