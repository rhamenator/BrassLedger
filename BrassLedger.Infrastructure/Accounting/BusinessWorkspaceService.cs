        ...
        return new BusinessWorkspaceSnapshot(
            ...
            Operations: new OperationsWorkspace(
                ...
                PurchaseOrders: purchaseOrders.Select(x => new PurchaseOrderSnapshot(
                    ...
                    x.Notes,
                    x.ConcurrencyToken,
                    purchaseOrderLineLookup[x.Id].Select(line => new PurchaseOrderLineSnapshot(line.Id, line.Sequence, line.InventoryItemId, inventoryItemById.GetValueOrDefault(line.InventoryItemId)?.Sku ?? "Unavailable", line.Description, line.OrderedQuantity, line.UnitCost, line.ReceivedQuantity, line.InvoicedQuantity, line.LineTotal, line.ReturnedQuantity, line.CreditedQuantity, line.ProjectJobId, line.ProjectPhaseId, line.ProjectCostCodeId)).ToArray())).ToArray(),
