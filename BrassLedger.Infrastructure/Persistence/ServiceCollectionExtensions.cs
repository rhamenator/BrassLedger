...
public static class ServiceCollectionExtensions
{
    ...
    private static async Task EnsureLegacySchemaCompatibilityAsync(BrassLedgerDbContext dbContext, CancellationToken cancellationToken)
    {
        if (dbContext.Database.IsSqlite())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS ""PayrollEarningLines"" (""Id"" TEXT NOT NULL PRIMARY KEY, ""PayrollRunEmployeeLineId"" TEXT NOT NULL, ""Sequence"" INTEGER NOT NULL, ""EarningCode"" TEXT NOT NULL, ""EarningType"" TEXT NOT NULL, ""Hours"" TEXT NOT NULL, ""Rate"" TEXT NOT NULL, ""Amount"" TEXT NOT NULL, ""IsTaxable"" INTEGER NOT NULL, ""WorkedOn"" TEXT NULL, ""WorkState"" TEXT NOT NULL, ""WorkCounty"" TEXT NOT NULL, ""WorkCity"" TEXT NOT NULL, ""WorkSchoolDistrict"" TEXT NOT NULL);", cancellationToken);
        ...
        if (dbContext.Database.IsNpgsql())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS ""PayrollEarningLines"" (""Id"" uuid NOT NULL PRIMARY KEY, ""PayrollRunEmployeeLineId"" uuid NOT NULL, ""Sequence"" integer NOT NULL, ""EarningCode"" text NOT NULL, ""EarningType"" text NOT NULL, ""Hours"" numeric(18,4) NOT NULL, ""Rate"" numeric(18,4) NOT NULL, ""Amount"" numeric(18,2) NOT NULL, ""IsTaxable"" boolean NOT NULL, ""WorkedOn"" date NULL, ""WorkState"" text NOT NULL, ""WorkCounty"" text NOT NULL, ""WorkCity"" text NOT NULL, ""WorkSchoolDistrict"" text NOT NULL);", cancellationToken);
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_PayrollEarningLines_PayrollRunEmployeeLineId_Sequence"" ON ""PayrollEarningLines"" (""PayrollRunEmployeeLineId"", ""Sequence"");", cancellationToken);
