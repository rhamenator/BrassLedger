...
public static class ServiceCollectionExtensions
{
    ...
    private static async Task EnsureLegacySchemaCompatibilityAsync(BrassLedgerDbContext dbContext, CancellationToken cancellationToken)
    {
        if (dbContext.Database.IsSqlite())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_PayrollEarningLines_PayrollTimeEntryId"" ON ""PayrollEarningLines"" (""PayrollTimeEntryId"") WHERE ""PayrollTimeEntryId"" IS NOT NULL;", cancellationToken);
