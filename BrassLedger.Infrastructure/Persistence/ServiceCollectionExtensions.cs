...
public static class ServiceCollectionExtensions
{
    ...
    private static async Task EnsureLegacySchemaCompatibilityAsync(BrassLedgerDbContext dbContext, CancellationToken cancellationToken)
    {
        if (dbContext.Database.IsSqlite())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS ""PayrollSsaWageFileConfigurations"" (""Id"" TEXT NOT NULL PRIMARY KEY, ""CompanyId"" TEXT NOT NULL, ""SpecificationTaxYear"" INTEGER NOT NULL, ""SpecificationVersion"" TEXT NOT NULL, ""LayoutCompatibilityCode"" TEXT NOT NULL, ""OfficialSpecificationUrl"" TEXT NOT NULL, ""OfficialSpecificationSha256"" TEXT NOT NULL, ""SourceRetrievedOn"" TEXT NOT NULL, ""ReviewNotes"" TEXT NOT NULL, ""SubmitterEin"" TEXT NOT NULL, ""BsoUserId"" TEXT NOT NULL, ""SubmitterName"" TEXT NOT NULL, ""LocationAddress"" TEXT NOT NULL, ""DeliveryAddress"" TEXT NOT NULL, ""City"" TEXT NOT NULL, ""State"" TEXT NOT NULL, ""PostalCode"" TEXT NOT NULL, ""ContactName"" TEXT NOT NULL, ""ContactPhone"" TEXT NOT NULL, ""ContactEmail"" TEXT NOT NULL, ""PreparerCode"" TEXT NOT NULL, ""EmployerLocationAddress"" TEXT NOT NULL, ""EmployerDeliveryAddress"" TEXT NOT NULL, ""EmployerCity"" TEXT NOT NULL, ""EmployerState"" TEXT NOT NULL, ""EmployerPostalCode"" TEXT NOT NULL, ""EmployerContactName"" TEXT NOT NULL, ""EmployerContactPhone"" TEXT NOT NULL, ""EmployerContactEmail"" TEXT NOT NULL, ""IsApproved"" INTEGER NOT NULL, ""ApprovedByUserId"" TEXT NULL, ""ApprovedAtUtc"" TEXT NULL, ""IsActive"" INTEGER NOT NULL, ""ConcurrencyToken"" TEXT NOT NULL);", cancellationToken);
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_PayrollSsaWageFileConfigurations_CompanyId_SpecificationTaxYear"" ON ""PayrollSsaWageFileConfigurations"" (""CompanyId"", ""SpecificationTaxYear"");", cancellationToken);
        ...
        if (dbContext.Database.IsNpgsql())
        {
            ...
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_PayrollFilingCorrections_CompanyId_OriginalPayrollFilingId_Sequence"" ON ""PayrollFilingCorrections"" (""CompanyId"", ""OriginalPayrollFilingId"", ""Sequence"");", cancellationToken);
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE TABLE IF NOT EXISTS ""PayrollSsaWageFileConfigurations"" (""Id"" uuid NOT NULL PRIMARY KEY, ""CompanyId"" uuid NOT NULL, ""SpecificationTaxYear"" integer NOT NULL, ""SpecificationVersion"" text NOT NULL, ""LayoutCompatibilityCode"" text NOT NULL, ""OfficialSpecificationUrl"" text NOT NULL, ""OfficialSpecificationSha256"" text NOT NULL, ""SourceRetrievedOn"" date NOT NULL, ""ReviewNotes"" text NOT NULL, ""SubmitterEin"" text NOT NULL, ""BsoUserId"" text NOT NULL, ""SubmitterName"" text NOT NULL, ""LocationAddress"" text NOT NULL, ""DeliveryAddress"" text NOT NULL, ""City"" text NOT NULL, ""State"" text NOT NULL, ""PostalCode"" text NOT NULL, ""ContactName"" text NOT NULL, ""ContactPhone"" text NOT NULL, ""ContactEmail"" text NOT NULL, ""PreparerCode"" text NOT NULL, ""EmployerLocationAddress"" text NOT NULL, ""EmployerDeliveryAddress"" text NOT NULL, ""EmployerCity"" text NOT NULL, ""EmployerState"" text NOT NULL, ""EmployerPostalCode"" text NOT NULL, ""EmployerContactName"" text NOT NULL, ""EmployerContactPhone"" text NOT NULL, ""EmployerContactEmail"" text NOT NULL, ""IsApproved"" boolean NOT NULL, ""ApprovedByUserId"" uuid NULL, ""ApprovedAtUtc"" timestamptz NULL, ""IsActive"" boolean NOT NULL, ""ConcurrencyToken"" text NOT NULL);", cancellationToken);
            await dbContext.Database.ExecuteSqlRawAsync(@"CREATE UNIQUE INDEX IF NOT EXISTS ""IX_PayrollSsaWageFileConfigurations_CompanyId_SpecificationTaxYear"" ON ""PayrollSsaWageFileConfigurations"" (""CompanyId"", ""SpecificationTaxYear"");", cancellationToken);
