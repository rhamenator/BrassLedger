...
internal sealed class StubAccountingTransactionService : IAccountingTransactionService
{
    ...
    public Task<TransactionResult> AssignRecurringOccurrenceRateAsync(AssignRecurringOccurrenceRateRequest request, CancellationToken cancellationToken = default) => Task.FromResult(TransactionResult.Success(Guid.NewGuid()));
