        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberAccountId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ConsolidationAccountMappings_ConsolidationGroups_Consolidat~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsolidationAccountMappings_ConsolidationGroupId_MemberCom~",
                table: "ConsolidationAccountMappings",
                columns: new[] { "ConsolidationGroupId", "MemberCompanyId", "MemberAccountId", "EffectiveFrom" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ConsolidationAccountMappings_ConsolidationGroupId_Reporting~",
                table: "ConsolidationAccountMappings",
