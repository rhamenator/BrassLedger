        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubledgerDocumentWorkflowId = table.Column<Guid>(type: "uuid", nullable: false),
                    RetainageReleaseOfProposalId = table.Column<Guid>(type: "uuid", nullable: true),
                    InvoiceNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    BillingThrough = table.Column<DateOnly>(type: "date", nullable: false),
                    InvoiceDate = table.Column<DateOnly>(type: "date", nullable: false),
                    DueDate = table.Column<DateOnly>(type: "date", nullable: false),
                    BillingBasis = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ProgressPercentToDate = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
                    CostMarkupPercent = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
                    ContractAmountSnapshot = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    RetainagePercentSnapshot = table.Column<decimal>(type: "numeric(9,6)", precision: 9, scale: 6, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectBillingProposals_ProjectBillingProposals_RetainageRe~",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectBillingProposals_SubledgerDocumentWorkflows_Subledge~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectJobId = table.Column<Guid>(type: "uuid", nullable: false),
                    EarningCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectBillingProposalId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    SourceCost = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    MarkupAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    GrossAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    RetainageAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    InvoiceAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    RevenueAccountNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectBillingLines_ProjectBillingProposals_ProjectBillingP~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectBillingSourceReservations_ProjectBillingProposals_Pr~",
                        column: x => x.ProjectBillingProposalId,
                        principalTable: "ProjectBillingProposals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectBillingProposals_CompanyId_ProjectJobId_Status_Billi~",
                table: "ProjectBillingProposals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectBillingRates_CompanyId_ProjectJobId_EarningCode_Effe~",
